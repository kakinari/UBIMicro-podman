...
podman build  -v /root/.cache/wagby/repository/trunk:/opt/Wagby-9.2.6/repository/trunk  -v /root/.cache/wagby/customize:/opt/Wagby-9.2.6/customize --build-arg TARGET=17 -t docker.io/kakinari/ubi-micro-ja:9-wagby-9.2.6 .
