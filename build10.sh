...
(cd ubi-micro-jbase; ./build-ubi-micro-jbase.sh 25)
(cd ubi-micro-jbase-nx; ./build-ubi-micro-jbase-nx.sh)
(cd ubi-micro-jbase-nx; ./build-ubi-micro-jbase-nx.sh 25)
(cd ubi-micro-dev; ./build-ubi-micro-dev.sh)
(cd ubi-micro-jdev; ./build-ubi-micro-jdev.sh)
(cd ubi-micro-jdev; ./build-ubi-micro-jdev.sh 25)
...
(cd ubi-micro-node; ./build-ubi-micro-node.sh 22)
